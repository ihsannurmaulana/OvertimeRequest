...
public class OvertimeController : ControllerBase
{
	...
	public IActionResult UpdateOver(OvertimeUpdateStatus updateOvertime)
	{
		...
		if (over == -1)
		{
			return NotFound(new ResponseHandler<OvertimeUpdateStatus>
			{
				Code = StatusCodes.Status404NotFound,
				Status = HttpStatusCode.NotFound.ToString(),
				Message = "ID Not Found!!"
		...
		{
			return StatusCode(StatusCodes.Status500InternalServerError, new ResponseHandler<OvertimeUpdateStatus>
			{
				Code = StatusCodes.Status500InternalServerError,
				Status = HttpStatusCode.InternalServerError.ToString(),
				Message = "Error to retrieving data from database"
		...
		{
			return Ok(new ResponseHandler<OvertimeUpdateStatus>
			{
				Code = StatusCodes.Status200OK,
				Status = HttpStatusCode.OK.ToString(),
				Message = "Successfull to update",
