...
public class OvertimeService
{
    ...
    public OvertimeDtoGet? GetOvertimeByGuid(Guid guid)
    {
        ...
        var employee = _employeeRepository.GetByGuid(overtime.Guid);
        var overtimeDtoGet = new OvertimeDtoGet();

        overtimeDtoGet.Guid = overtime.Guid;
        overtimeDtoGet.OvertimeNumber = overtime.OvertimeNumber;
        overtimeDtoGet.FullName = employee.FirstName + " " + employee.LastName;
        overtimeDtoGet.StartDate = overtime.StartDate;
        overtimeDtoGet.EndDate = overtime.EndDate;
        overtimeDtoGet.Status = overtime.Status;
        overtimeDtoGet.Remarks = overtime.Remarks;
        overtimeDtoGet.Remaining = overtime.Remaining;
        overtimeDtoGet.Paid = overtime.PaidOvertime;
        overtimeDtoGet.EmployeeGuid = overtime.EmployeeGuid;
        overtimeDtoGet.CreatedDate = overtimeDtoGet.CreatedDate;
        if (overtime is null) return null;

        return overtimeDtoGet;
    }
